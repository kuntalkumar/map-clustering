...
const MiniMap = () => {
  ...
  const calculateRoute = (destination, origin) => {
    ...
    routingControlRef.current.on("routesfound", (e) => {
      ...
      const totalDistance = summary.totalDistance / 1000; // Convert to kilometers
      setDistance(totalDistance);
    });

    // To prevent the route details from appearing over the map
        ...
        <div style={modalStyles}>
          <div style={modalContentStyles}>
            ...
            <div>
              <label>Source:</label>
              <select
                onChange={(e) => setStartPoint(locations[e.target.value])}
              >
            ...
            <div>
              ...
              <select
                onChange={(e) => setEndPoint(locations[e.target.value])}
              >
            ...
            <button
              onClick={() => handleSelection(startPoint, endPoint)}
